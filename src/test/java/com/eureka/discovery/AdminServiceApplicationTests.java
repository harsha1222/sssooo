...
import com.eureka.discovery.repository.FareRepository;
import com.eureka.discovery.service.AdminServiceImpl;
...
public class AdminServiceApplicationTests {
	...
	public void getAllDetailsTest2() { // Added train details
		...
		TrainDetails details = new TrainDetails((long) 123, "Mumbai", "Pune", "9:00AM", "5:00PM", "8H", 50, 1000, 750, 500,
				"1-JAN-2022");
